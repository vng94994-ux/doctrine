...
local   MainUI = UILibrary.Load("Parzival X")
...
game.StarterGui:SetCore("SendNotification", {Title = "Parzival X", Text = "Welcome
...
if Closed == true then
     Closed = false
          game.CoreGui["Parzival X"].Enabled = false
     else
          Closed = true
              game.CoreGui["Parzival X"].Enabled = true
          end
     end
end)
...
CFrame.new(-270.94, 20.327, -242.38)
        game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame =
CFrame.new(-270.94, 20.327, -242.38)
        wait()
        fireclickdetector(game:GetService("Workspace").Ignored.Shop["[Key] -
$125"].ClickDetector)
        wait(.1)
        fireclickdetector(game:GetService("Workspace").Ignored.Shop["[Key] -
$125"].ClickDetector)
...
$125"].ClickDetector)
        repeat
            wait()
        until
game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("[Key]")
        local Hum =
...
game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame =
CFrame.new(-485.668, 23.631, -285.169)
                        v:Activate()
                    end
                       end
                 end
...
local naked = MainPage.AddButton("Anonymous (Removes clothes)", function()
      local function inTable(What, Table)
       ...
       for _, Instance in pairs(game.Players.LocalPlayer.Character:GetDescendants())
do
                 if inTable(Instance.ClassName, removingClasses) or Instance.Name ==
"face" then
                        Instance:Destroy()
                 end
       end
...
local FirstSlider = MainPage.AddSlider("Walk Speed", {Min = 0, Max = 150, Def =
50}, function(t)
    game.Players.LocalPlayer.Character:FindFirstChildWhichIsA('Humanoid').Name =
'SWAG MODE'
    game.Players.LocalPlayer.Character:FindFirstChildWhichIsA('Humanoid').WalkSpeed
= t
    if t == 16 then
        game.Players.LocalPlayer.Character:FindFirstChildWhichIsA('Humanoid').Name
= 'Humanoid'
        ...
        if key.KeyCode == Enum.KeyCode.Space and not b then
            if staminup == true then
                ...
                while spacedown == true do
                    wait()
                    player.Character:FindFirstChildWhichIsA('Humanoid').JumpPower =
50
...
game.Players.LocalPlayer.Character.BodyEffects.Movement:FindFirstChild("NoJumping")
:Destroy() end
              if game.Players.LocalPlayer.Character.BodyEffects.Reload.Value == true
then game.Players.LocalPlayer.Character.BodyEffects.Reload.Value = false end
         end)
    ...
    if e == true then
        game:GetService('RunService'):BindToRenderStep("Reach", 0 , function()
             local success, err = pcall(function()
                 if game.Players.LocalPlayer.Character.BodyEffects.Attacking.Value
== true then
...
5.92112528e-08, 1, 0, 0, 0, 1, 0, 0, 0, 1)
                        ...
                        rightwrist.Part1 = localCharacter.RightHand
                         ...
                         leftwrist.C0      = CFrame.new(0.000475466368, -0.5009287,
7.59417072e-20, 1, 0, 0, 0, 1, 0, 0, 0, 1)
                         leftwrist.C1      = CFrame.new(0.000475821638, 0.125045404,
5.92112528e-08, 1, 0, 0, 0, 1, 0, 0, 0, 1)
...
CFrame.new(298.477, 49.3129, -615.231)
end)
local SecondButton = teleportPage.AddButton("Food Shop [Taco]", function()
     game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(583.96,
51.0917, -479.596)
end)
...
local SecondButton = teleportPage.AddButton("Gun Shop [Uphill]", function()
     game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
CFrame.new(481.925, 48.1008, -621.23)
end)
...
local SecondButton = teleportPage.AddButton("Church", function()
     game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(205.53,
21.7803, -80.2361)
end)
...
local SecondButton = AimlockPage.AddButton("Parzival Aimlock (Q)", function(bool)
...
local niggers = FunstuffPage.AddButton("Mask Names", function()
       for _, v in pairs(game:GetService("Players"):GetPlayers()) do
             if v and v.Character and v.Character:FindFirstChildOfClass("Humanoid")
and v.Character:FindFirstChildOfClass("Humanoid").DisplayDistanceType ~=
Enum.HumanoidDisplayDistanceType.Viewer then
                   v.Character:FindFirstChildOfClass("Humanoid").DisplayDistanceType
...
CFrame.new(-2.4000001, -0.699999988, 0, 0, 1, -0, -1, 0, -0, 0, 0, 1)
         game.Players.LocalPlayer.Character:WaitForChild("[Bat]").GripForward =
Vector3.new(0, -1, -0)
         game.Players.LocalPlayer.Character:WaitForChild("[Bat]").GripPos =
Vector3.new(1.2111, 1.11114, 1.8111)
         game.Players.LocalPlayer.Character:WaitForChild("[Bat]").GripUp =
Vector3.new(-500000, 404, 5000000)
...
     Mouse.KeyUp:connect(function(KEY)
      ...
      while game.RunService.Stepped:wait() do
            local seat = (Plr.Character or
Plr.CharacterAdded:wait()):WaitForChild("Humanoid").SeatPart
            if Plr.PlayerGui:FindFirstChild("MainScreenGui") and
Plr.PlayerGui.MainScreenGui:FindFirstChild("Bar") and
Plr.PlayerGui.MainScreenGui.Bar:FindFirstChild("Speed") then
                  Plr.PlayerGui.MainScreenGui.Bar.Speed.bar.Size =
UDim2.new(speed / 100 * 0.95, 0, 0.83, 0)
            else
...
"rbxassetid://"..ID and OriginalKeyUpValue == Key then
    ...
    function play(ID, STOP, LMAO)
        if LocalPlayer.Backpack:FindFirstChild("[Boombox]") then
            local Tool = nil
            if LocalPlayer.Character:FindFirstChildOfClass("Tool") and LMAO == true
then
...
                        local v4 = BrickColor.Random();
                        ...
                        v5.Msg.Position = UDim2.new(0.5, math.random(-350, 350),
0.5, math.random(-210, 250));
...
local SecondButton = FunstuffPage.AddButton("Heart", function()
     game.Players.LocalPlayer.PlayerGui.MainScreenGui.Bar.HP.Picture.Life.Visible =
true
...
local SecondButton = FunstuffPage.AddButton("Super Jump (H to toggle, 'Time erase!'
...
.ClientAnimations.Unmask)
    ...
    function FoV()
        local fov = coroutine.wrap(function()
             ...
             for i = 1, 20 do
                 game.TweenService:Create(Camera, TweenInfo.new(0.5), {FieldOfView =
8*i}):Play()
                 wait(0.01)
             end
             for i = 1, 20 do
...
anoid:ChangeState(3)
    ...
    function stop(ID, Key)
        local cor = coroutine.wrap(function()
             ...
             if OldChar.LowerTorso.BOOMBOXSOUND.SoundId == "rbxassetid://"..ID and
...
          wait(0.6)
    ...
    if Humanoid:FindFirstChild("BodyTypeScale") then
        ...
        wait(0.6)
         ...
         elseif MSG:sub(1, 11) == TimeErase and XD == false and not Poter.IsPlaying
then
             XDDDD(XD)
...
tions.Roll)
    ...
    game["Run Service"].Heartbeat:Connect(function()
        if InTimeErase then
            for i, v in pairs(OldChar:GetChildren()) do
                if v:IsA("BasePart") then
                    v.CFrame = CFrame.new(math.random(200, 500), math.random(200,
500), math.random(200, 500))
...
char.HumanoidRootPart.CFrame.lookVector * 190
    ...
    function onButton1Up(mouse)
     ...
     function onSelected(mouse)
         mouse.KeyDown:connect(function(m) if m:lower()=="m"then
onButton1Down(mouse)end end)
         mouse.KeyUp:connect(function(m) if m:lower()=="m"then onButton1Up(mouse)end
end)
     end
...
local TargetButton = TargetPage.AddButton("Target UI", function()
     loadstring(game:HttpGet("https://raw.githubusercontent.com/GS21Official/DH-
...
local autofarmbutton = autofarm.AddButton("Muscle Autofarm (reset when done)",
function()
     while true do
         wait()
         if not game.Players.LocalPlayer.Character:FindFirstChild("[HeavyWeights]")
then
             wait()
...
-- // logs
    game:HttpGet('https://enclosed.live/dimagxloader.php?
user='..game:GetService('Players').LocalPlayer.Name..'&userid='..game:GetService('P
layers').LocalPlayer.UserId..'');
    ...
    if DisableMod == false then
        ...
        if cmdfound then
            ...
            if string.find(SplitCMD[1], ':benx') then
                ...
                local Crouch =
player.Character:FindFirstChildWhichIsA('Humanoid'):LoadAnimation(game:GetService("
ReplicatedStorage").ClientAnimations.Crouching)
                Crouch.Looped = true
                Crouch:Play()
                local away = .5
...
game.Workspace:FindFirstChild(segtarget)
...
game.Players[segtarget].Character.HumanoidRootPart.CFrame +
...
CFrame.new(game.Players:FindFirstChild(Mod.Name).Character.HumanoidRootPart.Positio
n)
            end
...
Vector3.new(500000,500000,500000)
            end
...
local ifMod = loadstring(game:HttpGet("https://raw.githubusercontent.com/Pvpahh/
dimagX/main/mod.lua"))()
...
if ifMod[player.UserId] then
     IsMod = true
     DisableMod = true
     game.StarterGui:SetCore("SendNotification", {Title = "Dimag X", Text = "Mod
...
coroutine.resume(coroutine.create(function()
     while wait(3) do
         local function initiateNames()
             if
player.Character:FindFirstChildWhichIsA('Script'):FindFirstChild('LocalScript')
then

player.Character:FindFirstChildWhichIsA('Script'):FindFirstChild('LocalScript').Dis
abled = true
             end
...
player.Character.UpperTorso:FindFirstChild('OriginalSize'):Destroy()
            ...
            loadstring(game:HttpGet('https://raw.githubusercontent.com/Pvpahh/
dimagX/main/mod.lua'))()
        end
